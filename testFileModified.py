...
lovely_rules = KnowledgeBase({'loves': [Rule(Fact('loves', [Term('hanna'), Term('miles')]), None), Rule(Fact('loves', [Term('simon'), Term('sara')]), None), Rule(Fact('loves', [Term('tom'), Term('tom')]), None)], 'narcissist': [Rule(Fact('narcissist', [Var('X')]), Fact('loves', [Var('X'), Var('X')]))]})
...
print('---~~Mortality~~---')
from nodes import Var, Term, Fact, Conjuction, Goals, Rule, Rules
mortality_rules = KnowledgeBase({'human': [Rule(Fact('human', [Term('miles')]), None), Rule(Fact('human', [Term('socrates')]), None)], 'mortal': [Rule(Fact('mortal', [Var('X')]), Fact('human', [Var('X')]))]})
